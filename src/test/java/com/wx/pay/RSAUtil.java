...
public class RSAUtil {
    ...
    static String  getToken(String prepayId) throws IOException, SignatureException, NoSuchAlgorithmException, InvalidKeyException {
   ...
   static String sign(byte[] message, PrivateKey privateKey) throws SignatureException, NoSuchAlgorithmException, InvalidKeyException {
